...
You can install the development version of **sacmetrics** from [GitHub](https://github.com/) with:
...
Feel also free to contact us by creating [an issue](https://github.com/nowosad/sacmetrics/issues).
